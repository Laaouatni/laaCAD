<script lang="ts">
  ...
  import CadRectMoveUtility from "$components/CAD/CadProjectViewCanvas/CadComponents/CadUtilities/CadRectMoveUtility/CadRectMoveUtility.svelte";
...
{#each possiblePositions as thisPossiblePosition}
  <CadRectMoveUtility
    ...
    compPropX={compPropCadElementObj.geometryData.position[thisPossiblePosition]
      .x}
    compPropY={compPropCadElementObj.geometryData.position[thisPossiblePosition]
      .y}
  ></CadRectMoveUtility>
{/each}
